...
class _SucceedPageState extends State<SucceedPage>
  ...
  static const Color zenIndigo = Color(
    0xFFFF6B00,
  ); // primary = JNE orange (minimalis)
            ...
            children: [
              ...
              Text(
                widget.isEnroll
                    ...
                    : context.tr('attendance_success_title'),
              ...
              Text(
                widget.isEnroll
                    ? context.tr('enroll_success_sub')
                    : context.tr('attendance_success_sub'),
