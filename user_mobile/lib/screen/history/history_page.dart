...
class _HistoryPageState extends State<HistoryPage> {
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.plusJakartaSans(
              color: zenSlate.withValues(alpha: 0.6),
              fontSize: 13,
  ...
  Widget _buildAttendanceCard(BuildContext context, AttendanceRecord r) {
    ...
    if (isLate) {
      statusColor = zenRose;
      statusLabel = context.tr('status_late');
    }
    if (isAbsent) {
      statusColor = zenRose;
      statusLabel = context.tr('status_absent_full');
    }
    if (isLeave) {
      statusColor = zenIndigo;
      statusLabel = context.tr('status_leave_full');
    }
