...
class _ChatPageState extends State<ChatPage> {
  ...
  Future<void> _initChat() async {
    // Guard supaya listener tidak dibuat ulang kalau widget rebuild.
    ...
    final newChatId = chat.getChatId(app.currentUser!.uid, admin.uid);
    if (_chatId == newChatId) return;
    ...
    chat.listenToMessages(newChatId);
  }
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (_targetAdmin?.isOnline ?? false)
                            ? Colors.greenAccent
                            : Colors.white38,
                        shape: BoxShape.circle,
                      ),
          ...
          Expanded(
            child: chat.isLoading || _targetAdmin == null
                ...
                : ListView.builder(
                    ...
                    itemCount:
                        chat.messages.length + (chat.otherUserTyping ? 1 : 0),
  ...
  void _showDeleteDialog(ChatMessage msg, ChatProvider chat) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text(
          'Pesan ini akan dihapus untuk semua orang.',
                ...
                Expanded(
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      onChanged: (val) {
                        // Throttle typing update biar tidak spam Firestore.
                        // Ini mengurangi potensi UI 'muter' karena banyak rebuild.
                        final p = context.read<ChatProvider>();
                        p.updateTyping(_chatId!, val.isNotEmpty);
                      },
