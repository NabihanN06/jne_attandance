...
class _RecapPageState extends State<RecapPage> {
  ...
  bool _isCourier(String dept) => RegExp(
    r'rider|driver|delivery|kurir',
    caseSensitive: false,
  ).hasMatch(dept);
    ...
    return Scaffold(
      ...
      body: FutureBuilder<_RecapData>(
        ...
        builder: (context, snap) {
          ...
          final hours = (r.workMinutes / 60).toStringAsFixed(
            r.workMinutes % 60 == 0 ? 0 : 1,
          );
          return ListView(
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _stat(
                    pal,
                    '${r.late}',
                    context.tr('recap_late'),
                    Icons.schedule_rounded,
                    AppColors.amber,
                  ),
                  _stat(
                    pal,
                    '$hours ${context.tr('recap_hours')}',
                  ...
                  if (r.overtimeMinutes > 0)
                    _stat(
                      pal,
                      '${(r.overtimeMinutes / 60).toStringAsFixed(1)} ${context.tr('recap_hours')}',
